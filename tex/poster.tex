...
\column{0.25}
\block{\gls{ROS} packages}{
Accepted in official \gls{ROS} distribution.

\begin{itemize}
    \item \texttt{multirobot\_map\_merge}: map-merging without knowledge of initial positions
    \item \texttt{explore\_lite}: autonomous exploring
\end{itemize}

Source: \url{https://github.com/hrnr/m-explore.git}
Author: Jiri Horner \textless laeqten AT gmail DOT com\textgreater
} % end block
