...
\begin{itemize}
    ...
    \item for effective coordination robots needs global map
...
\begin{tikzfigure}[Maps produced by a multi-robot mapping in the simulator with $3$ robots. The merged map (right) is estimated by the map-merging node without knowledge of initial positions.]
    \vspace{-1.5em}
