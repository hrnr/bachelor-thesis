...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \Procedure{estimateGridTransform}{$grids$}
            ...
            \State \Call{estimateFinalTransform}{$t$, $P_{(i,j)} \forall e \in \text{edges of } t$} \Comment{walk $t$ and compute transformations to global reference frame.}
        \EndProcedure
    \end{algorithmic}
\end{algorithm}
