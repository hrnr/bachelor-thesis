...
Idea for dynamic robot discovery is from \href{http://wiki.ros.org/map\_merging}{map\_merging} package from Zhi Yan. Merging algorithm and configuration are different.
